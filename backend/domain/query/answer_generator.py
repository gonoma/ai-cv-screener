...
class AnswerGenerator:
    SYSTEM_PROMPT: str = (
        ...
        "paragraph per reason or per candidate. Name each person you describe once, at\n"
        "their first mention — an answer about someone that never says who it is about\n"
        "is unusable — then carry on without repeating the full name, which at the head\n"
        "of every paragraph reads like a form letter. Repeat it only where the answer\n"
        "moves between several people and the reader could lose track.\n"
        "\n"
